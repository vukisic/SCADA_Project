...
namespace Simulator.Core
{
    public interface ISimulator
    {
        ...
        void MarshalUnmananagedArray2Struct(IntPtr unmanagedArray, int length, out List<dnp3_protocol.dnp3types.sServerDatabasePoint> mangagedArray);
        List<Point> ConvertToPoints(List<dnp3_protocol.dnp3types.sServerDatabasePoint> mangagedArray);
